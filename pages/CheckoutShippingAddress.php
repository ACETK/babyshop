<?php
$Temp="";
$Temp.='<div class="cont_heading_tl">
            ...
            <div class="content_wrapper_bl s_width2_100">
                <div class="content_wrapper_br content_wrapper1_padd">
                    <div class="s_width2_100">
                                                    ...
                                                    <div class="wrapper_pic2_br wrapper_pic2_padd">
                                                        <div class="s_width2_100">
                                                            <table width="100%" cellspacing="0" cellpadding="2" border="0"><tbody><tr>
                                                                        ...
                                                                        <td width="50%" class="main">This is the currently selected shipping address where the items in this order will be delivered to.</td>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="2" border="0">
                            <tbody><tr>
                                    <td class="main indent_2"><b>New Shipping Address</b></td>
                                </tr>
                            </tbody></table>
                                                ...
                                                <div class="wrapper_pic2_bl">
                                                    <div class="wrapper_pic2_br wrapper_pic2_padd">
                                                        <div class="s_width2_100">
                                                            <table width="100%" cellspacing="0" cellpadding="2" border="0"><tbody><tr>
                                                                        <td><img width="10" height="1" border="0" alt="" src="images/pixel_trans.gif"></td>
                                                                        <td width="100%" class="main">Please use the following form to create a new shipping address to use for this order.</td>
                                                                        <td><img width="10" height="1" border="0" alt="" src="images/pixel_trans.gif"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img width="10" height="1" border="0" alt="" src="images/pixel_trans.gif"></td>
                                                    ...
                                                    <div class="wrapper_pic2_br wrapper_pic2_padd">
                                                        <div class="s_width2_100">
                                                            <table width="100%" cellspacing="0" cellpadding="2" border="0"><tbody><tr>
                                                                        ...
                                                                        <td align="right" class="main vam bg_input"><input type="hidden" value="submit" name="action"><input type="image" title=" Continue " alt="Continue" src="includes/languages/english/images/buttons/button_continue.gif"></td>
                                                                        <td width="10"><img width="10" height="1" border="0" alt="" src="images/pixel_trans.gif"></td>
                                                                    </tr>
                                                                </tbody></table>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tbody><tr>
                                    ...
                                    <td width="25%"><img width="100%" height="1" border="0" alt="" src="images/pixel_silver.gif"></td>
                                    <td width="25%"><img width="100%" height="1" border="0" alt="" src="images/pixel_silver.gif"></td>
                                    <td width="25%"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tbody><tr>
                                                    <td width="50%"><img width="100%" height="1" border="0" alt="" src="images/pixel_silver.gif"></td>
