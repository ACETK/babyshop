                                        ...
                                        <table cellspacing="4" cellpadding="2" border="0">
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="main width2_100"><input type="text" name="dob">&nbsp;<span class="inputRequirement">* (vd. 12/02/1970)</span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <select name="loaitaikhoan">';
                                                                    ...
                                                                    $r = MySQLHelper::executeQuery($sql);
                                                                   while($mang = mysql_fetch_array($r)) {
                                                                        $Temp.=' <option value="'.$mang['MaLoai'].'" SELECTED>'.$mang['TenLoai'].'</option>';
...
//////lay du lieu tu trang tao tk///////////
    ...
    $nam = substr($ns,6,4);
    $ntn = $nam."-".$thang."-". $ngay;
            $sql = sprintf("INSERT INTO nguoidung (TenTaiKhoan, TenNguoiDung, MatKhau,NgaySinh,GioiTinh,DiaChi,DienThoai,Email,MaLoai) VALUES ('%s', '%s','%s', '%s', '%s','%s','%s', '%s','%s')",$tk,$ht,$mk,$ntn,$gt,$dc,$dt,$em,$mltk);
            $result = MySQLHelper::executeQuery($sql);
            if($result==1){
                $Temp.="Thêm tài khoản $tk thành công! <a href='admin.php?page=QuanLyNguoiDung'>Quay lại</a>";
            }
...
$ctpl->assign('ContentTitle',"Quản lý người dùng - Thêm tài khoản");
