...
--
-- Host: localhost
-- Generation Time: Aug 14, 2010 at 02:34 PM
...
INSERT INTO `dochoi` (`MaDoChoi`, `TenDoChoi`, `MaLoai`, `MaNSX`, `DonGia`, `ThongTin`, `HinhAnh`, `SoLuotXem`, `NgayNhap`, `SoLuong`, `TinhTrang`) VALUES
('SP0000', 'Ghế nằm ăn rung', 9, 4, '1279000', 'Ghế rung nhè nhẹ để vỗ về bé. Ghế có 3 món đồ chơi gắn trên thành, Có thể tháo rời. Cần pin (chưa bao gồm trong sản phẩm). Dành cho bé từ sơ sinh trở đi.', 'SP0000.jpg', 1, '2010-05-05', 0, 0),
('SP0001', 'Vòm san hô cá', 6, 7, '310000', 'Vòm san hô cá là đồ chơi yêu thích của bé. Mô tả đặc trưng “chơi và phát triển” cùng với chuyển động động lực. Món đồ chơi Lamaze này có khóa cho phép để đồ chơi chắc chắn trên bất kỳ bề mặt nào, làm cho bữa ăn của bé thêm vui! ', 'SP0001.gif', 24, '2010-05-05', 0, 0),
('SP0002', 'Treo nôi có nhạc, đèn', 6, 6, '850000', 'Giấc ngủ rất quan trọng với trẻ thơ. Trẻ sẽ dễ dàng đi vào giấc ngủ nhờ những giấc mơ trong màn chiếu động điều khiển được từ xa. Thật vậy, nhờ ánh sáng chiếu êm dịu, âm nhạc nhẹ nhàng, trẻ sẽ từ từ đi vào thế giới của những giấc mơ. Điểm nổi bật của', 'SP0002.jpg', 1, '2010-05-05', 0, 0),
('SP0003', 'Đàn hình tổ chim', 6, 6, '388000', 'Chơi nhạc với Lamaze ! Tám thanh nhạc rực rỡ sắc màu làm mái cho ngôi nhà chim xinh đẹp. Khuyến khích bé chơi nhạc độc lập, hoặc cùng chơi với bố, mẹ hay người trông trẻ !  Đàn hình tổ chim có đầy đủ nốt nhạc mà em bé có thể chơi bằng phím bấm vừa ta', 'SP0003.gif', 2, '2010-05-05', 0, 0),
...
('SP0007', 'Tập làm nhà xây dựng', 3, 4, '757440', 'The Build ''n Play Bins are part of the brand new LP Builders Line. These great storage bins take a classic, popular building format to a whole new level by incorporating fun toddler activities into the play. All new block design is just perfect for l', 'SP0007.jpg', 1, '2010-05-05', 0, 0),
('SP0008', 'Khối xếp hình lâu đài', 3, 5, '565000', 'Khối xếp hình lâu đài. Kích cỡ : 30 x 42 x 6 cm. 12 x 17 x 2 1/2 in.', 'SP0008.jpg', 2, '2010-05-05', 0, 0),
('SP0009', 'Bé học xem giờ', 8, 5, '115000', 'Cái đồng hồ học xem giờ này có các vạch đếm rõ ràng để bé xác định được sổ phút trong một giờ, trong nửa giờ, trong một khắc (15 phút). Ngoài ra giúp bé hiểu về phân số một cách cơ bản. ', 'SP0009.jpg', 2, '2010-05-05', 0, 0),
...
('SP0013', 'Xe đẩy siêu tiện lợi', 9, 6, '4231500', 'One hand fold, manoeuvrable - Fits 2 infant car seats for Travel System - Back seat for newborn - Front seat from 6 months - Child tray in the back - Sportive handle with 2 handgrips - Large drop down shopping basket - Parents storage and cupholder - 4 positions recline(back seat), 2 positions recline (front seat', 'SP0013.jpg', 1, '2010-05-10', 0, 0),
('SP0014', 'Xe đẩy Graco-Mirage Plus', 9, 6, '2976000', 'Xe đẩy siêu nhẹ thuận tiện cho bạn & bé đi du lịch, để trên xe ô tô, máy bay. + Xe đẩy gấp gọn bằng 1 tay. + Xe đẩy có 3 chế độ ngồi, có chế độ nằm 150 độ cho bé từ 6 tháng tuổi. + Bánh xe có khoá an toàn, dễ dàng để mọi nơi.', 'SP0014.jpg', 5, '2010-05-10', 0, 0),
('SP0015', 'Cuộc chiến ngoài vũ trụ', 3, 4, '1729000', 'Bé có thể tạo cho mình nhiều loại xe khác nhau nhiều loại máy khác nhau tạo ra một cuộc chiến không gian. Giúp bé yêu thích khả năng sáng tạo yêu thích khoa học. ', 'SP0015.jpg', 8, '2010-05-10', 0, 0),
('SP0016', 'Ngôi nhà xinh xắn', 3, 2, '1429000', 'Bé có thể tạo cho mình một ngôi nhà xinh xắn từ những mảnh ghép đa sắc. Giúp be sáng tạo hơn trong kiến trúc sư. Bé có thể tạo nên những ngôi nhà khác nhau trong nhiều mảnh ghép.Giúp bé có khả năng trở thành nhà kiến trúc sau này. ', 'SP0016.jpg', 2, '2010-05-10', 0, 0),
('SP0017', 'Phi cơ Lego', 3, 2, '379000', NULL, 'SP0017.jpg', 0, '2010-05-10', 0, 0),
('SP0018', 'Xếp hình xe tải', 3, 2, '499000', 'Bộ sản phẩm rất tiện lợi. Nó gồm những nhiều mảnh ghép khác nhau tạo được rất nhiều mô hìnhxe tải. Tạo cho bé có khả năng tư duy sáng tạo trong lúc chơi. Lúc chơi xong bé có thể gom lại và bỏ vào thùng cất giữ gọn gàng ngăn nắp. ', 'SP0018.jpg', 1, '2010-05-12', 0, 0),
('SP0019', 'Cũi em bé có bánh và màn che', 9, 4, '2021000', 'Cũi rộng, an toàn, chắc chắn. Cũi dùng cho em bé chơi hoặc ngủ. Gồm có cửa kéo khoá dễ dàng. Cũi có bánh xe & phanh an toàn. Cũi gấp gọn dễ dàng khi không sử dụng. Cũi có 2 màu (da cam hoặc xanh) ', 'SP0019.jpg', 6, '2010-05-12', 0, 0);
...
INSERT INTO `khuyenmai` (`MaDoChoi`, `DonGia`, `Banner`, `GhiChu`) VALUES
('SP0004', '120000', 'SP0004BN.jpg', 'hahaha'),
('SP0005', '300000', 'SP0005BN.jpg', 'xong rùi'),
('SP0009', '100000', 'SP0009BN.jpg', 'test lần cuối'),
('SP0019', '3000000', 'SP0019BN.jpg', 'nâng giá');
...
INSERT INTO `nguoidung` (`TenTaiKhoan`, `TenNguoiDung`, `MatKhau`, `NgaySinh`, `GioiTinh`, `DiaChi`, `DienThoai`, `Email`, `MaLoai`, `TinhTrang`) VALUES
('admin', 'Quản trị website', 'admin', NULL, NULL, NULL, NULL, NULL, 'admin', 0),
('user', 'Khách hàng', 'user', NULL, NULL, NULL, NULL, NULL, 'user', 0);
...
(2, 'BENHO', 'không biết', '083000có', 'email@email.email', 0),
...
--
ALTER TABLE `hdnhap`
  ADD CONSTRAINT `hdnhap_ibfk_1` FOREIGN KEY (`MaDoChoi`) REFERENCES `dochoi` (`MaDoChoi`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `hdxuat`
--
ALTER TABLE `hdxuat`
  ADD CONSTRAINT `hdxuat_ibfk_1` FOREIGN KEY (`MaDoChoi`) REFERENCES `dochoi` (`MaDoChoi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `hdxuat_ibfk_2` FOREIGN KEY (`TenTaiKhoan`) REFERENCES `nguoidung` (`TenTaiKhoan`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `khuyenmai`
--
ALTER TABLE `khuyenmai`
  ADD CONSTRAINT `khuyenmai_ibfk_1` FOREIGN KEY (`MaDoChoi`) REFERENCES `dochoi` (`MaDoChoi`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `nguoidung`
--
ALTER TABLE `nguoidung`
  ADD CONSTRAINT `nguoidung_ibfk_1` FOREIGN KEY (`MaLoai`) REFERENCES `loaitk` (`MaLoai`) ON DELETE NO ACTION ON UPDATE NO ACTION;
